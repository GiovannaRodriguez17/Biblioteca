...
public class Excel {
   ...
   public static ObservableList<Usuario>  excelUsuario() {
       ...
       try {
           String rutaArchivoExcel = "C:\\Users\\Giovanna Rodriguez\\Desktop\\PRACTICAS\\Cajero\\Biblioteca\\src\\main\\resources\\BD\\Usuarios.xlsx";
       ...
       public static ObservableList<Libro>  excelLibro(){
           ...
           try {
               String rutaArchivoExcel = "C:\\Users\\Giovanna Rodriguez\\Desktop\\PRACTICAS\\Cajero\\Biblioteca\\src\\main\\resources\\BD\\Libros.xlsx";
               FileInputStream inputStream = new FileInputStream(new File(rutaArchivoExcel));
               Workbook workbook = new XSSFWorkbook(inputStream);
               Sheet firstSheet = workbook.getSheetAt(0);
               Iterator<Row> iterator = firstSheet.iterator();
       ...
       public static ObservableList<Tesis>  excelTesis(){
           ...
           try {
               String rutaArchivoExcel = "C:\\Users\\Giovanna Rodriguez\\Desktop\\PRACTICAS\\Cajero\\Biblioteca\\src\\main\\resources\\BD\\Tesis.xlsx";
               FileInputStream inputStream = new FileInputStream(new File(rutaArchivoExcel));
               Workbook workbook = new XSSFWorkbook(inputStream);
               Sheet firstSheet = workbook.getSheetAt(0);
               Iterator<Row> iterator = firstSheet.iterator();
       ...
       public static ObservableList<Revista>  excelRev(){
           ...
           try {
               String rutaArchivoExcel = "C:\\Users\\Giovanna Rodriguez\\Desktop\\PRACTICAS\\Cajero\\Biblioteca\\src\\main\\resources\\BD\\Revista.xlsx";
               FileInputStream inputStream = new FileInputStream(new File(rutaArchivoExcel));
               Workbook workbook = new XSSFWorkbook(inputStream);
               Sheet firstSheet = workbook.getSheetAt(0);
               Iterator<Row> iterator = firstSheet.iterator();
       ...
       public static ObservableList<Prestamo>  excelPrestamo(){
           ...
           try {
               String rutaArchivoExcel = "C:\\Users\\Giovanna Rodriguez\\Desktop\\PRACTICAS\\Cajero\\Biblioteca\\src\\main\\resources\\BD\\Prestamo.xlsx";
               FileInputStream inputStream = new FileInputStream(new File(rutaArchivoExcel));
               Workbook workbook = new XSSFWorkbook(inputStream);
               Sheet firstSheet = workbook.getSheetAt(0);
               Iterator<Row> iterator = firstSheet.iterator();
